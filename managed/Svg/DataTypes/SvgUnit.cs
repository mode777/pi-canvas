...
namespace Svg
{
    ...
    public struct SvgUnit
    {
        ...
        public float ToDeviceValue(UnitRenderingType renderType, SvgElement owner)
        {
            ...
            switch (type)
            {
                ...
                case SvgUnitType.Percentage:
                    ...
                    //var boundable = owner == null ? null : owner.OwnerDocument;
                    //if (boundable == null)
                    //{
                    //    _deviceValue = value;
                    //    break;
        ...
        {
            return value.ToDeviceValue(UnitRenderingType.Other, null);
        }
        ...
        public static System.Drawing.PointF GetDevicePoint(SvgUnit x, SvgUnit y, SvgElement owner)
        {
            return new System.Drawing.PointF(x.ToDeviceValue(UnitRenderingType.Horizontal, owner),
                                             y.ToDeviceValue(UnitRenderingType.Vertical, owner));
        }
        public static System.Drawing.PointF GetDevicePointOffset(SvgUnit x, SvgUnit y, SvgElement owner)
        {
            return new System.Drawing.PointF(x.ToDeviceValue(UnitRenderingType.HorizontalOffset, owner),
                                             y.ToDeviceValue(UnitRenderingType.VerticalOffset, owner));
        }

        public static System.Drawing.SizeF GetDeviceSize(SvgUnit width, SvgUnit height, SvgElement owner)
        {
            return new System.Drawing.SizeF(width.ToDeviceValue(UnitRenderingType.HorizontalOffset, owner),
                                            height.ToDeviceValue(UnitRenderingType.VerticalOffset, owner));
        }
    }
